  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Simplifying table reservations and menu management for restaurants and offering seamless booking for customers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Simplifying table reservations and menu management for restaurants and offering seamless booking for customers.`}
            </Text>
            <Box
